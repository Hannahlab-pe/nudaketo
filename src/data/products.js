// Catálogo NUDA KETO — datos tomados del catálogo oficial (Catalogo.pdf, 23 pp.)
//
// PENDIENTE DE CONFIRMAR CON CLIENTE (ver comentarios "REVISAR" más abajo):
//  1. Proteína de Galletón Chips Almendras y Galletón Cacao Nibs: el empaque
//     fotografiado dice 6 g y 7 g, pero la tabla nutricional del catálogo dice
//     5 g en ambos. Usamos el valor del EMPAQUE (es la declaración impresa que
//     recibe el cliente). Si el bueno es el de la tabla, cambiar en 2 sitios.
//  2. Tortas y cuchareables no traen tabla nutricional ni gramaje en el
//     catálogo: `nutrition` y `netWeight` quedan en null hasta tenerlos.
...
export const products = [
  // ─────────────────────────────  GALLETONES  ─────────────────────────────
  {
    ...
    description:
      'Galletón keto de vainilla con chips de chocolate y almendra en hojuela. Crujiente por fuera, suave por dentro y lleno de sabor.',
    highlights: [
      ...
      'Sin azúcar añadida',
      'Gluten free',
      '6 g de proteína por galletón', // REVISAR: tabla del catálogo dice 5 g
    ...
    nutrition: { serving: '1 galletón · 45 g', kcal: 205, fat: '17 g', carbs: '8 g', protein: '6 g' }, // REVISAR proteína
    sizes: [
  ...
  },
  {
    ...
    nutrition: { serving: '1 galletón · 45 g', kcal: 209, fat: '17 g', carbs: '8 g', protein: '6 g' },
    sizes: [
      { id: 'ind', label: 'Individual', size: '45g', pieces: '1 galletón', price: 9.9 },
      { id: 'pack', label: 'Pack x3', size: '135g', pieces: '3 galletones', price: 28.5 },
    ],
  ...
  },
  {
    ...
    description:
      'Galletón keto premium elaborado con harina de almendra y vainilla natural, combinado con chips de chocolate sin azúcar para lograr un equilibrio perfecto entre suavidad, dulzor y textura.',
    highlights: [
      'Vainilla natural y textura chewy',
      'Chips de chocolate 70%',
      'Endulzado con alulosa y extracto de monk fruit',
    ...
    nutrition: { serving: '1 galletón · 45 g', kcal: 196, fat: '16 g', carbs: '8 g', protein: '5 g' },
    sizes: [
      { id: 'ind', label: 'Individual', size: '45g', pieces: '1 galletón', price: 9.9 },
      { id: 'pack', label: 'Pack x3', size: '135g', pieces: '3 galletones', price: 28.5 },
    ],
  ...
  },
  {
    ...
    description:
      'Galletón keto premium elaborado con harina de almendra, cacao puro y nibs de cacao tostado, pensado para quienes disfrutan sabores intensos y auténticos en una alternativa saludable.',
    highlights: [
      'Chocolate intenso y textura chewy',
      ...
      'Sin azúcar añadida',
      'Gluten free',
      '7 g de proteína por galletón', // REVISAR: tabla del catálogo dice 5 g
    ...
    nutrition: { serving: '1 galletón · 45 g', kcal: 192, fat: '16 g', carbs: '7 g', protein: '7 g' }, // REVISAR proteína
    sizes: [
      { id: 'ind', label: 'Individual', size: '45g', pieces: '1 galletón', price: 9.9 },
      { id: 'pack', label: 'Pack x3', size: '135g', pieces: '3 galletones', price: 28.5 },
    ],
  ...
  // ───────────────────────────────  BARRAS  ───────────────────────────────
  {
    ...
    description:
      'Barra keto premium elaborada con cacao puro y frutos secos seleccionados, diseñada para ofrecer energía, saciedad y una experiencia intensa de sabor en un formato práctico y saludable.',
    highlights: [
    ...
    nutrition: { serving: '1 barra · 35 g', kcal: 192, fat: '16 g', carbs: '6 g', protein: '6 g' },
    sizes: [
  ...
  },
  {
    ...
    nutrition: { serving: '1 barra · 35 g', kcal: 179, fat: '18 g', carbs: '10 g', protein: '4 g' },
    sizes: [
      { id: 'ind', label: 'Individual', size: '35g', pieces: '1 barra', price: 10.9 },
    ],
    badge: null,
  ...
  // ─────────────────────────────  KETO BITES  ─────────────────────────────
  {
    ...
    nutrition: { serving: '1 bite · 23.5 g aprox.', kcal: 140, fat: '12 g', carbs: '6 g', protein: '2 g' },
    sizes: [
      { id: 'pack-141', label: 'Bolsa Grande', size: '141g', pieces: '6 unidades', price: 31.9 },
      { id: 'pack-70', label: 'Bolsa Pequeña', size: '70g', pieces: '3 unidades', price: 15.9 },
    ],
    badge: null,
    accentClass: 'text-nk-olive',
    btnClass: 'bg-nk-olive hover:bg-nk-choco text-nk-ivory',
  ...
  // ───────────────────────────────  TORTAS  ───────────────────────────────
  {
    ...
    description:
      'Torta húmeda de chocolate amargo, de sabor intenso y textura suave, rellena y cubierta con una cremosa ganache de chocolate sin azúcar.',
    highlights: [
      'Chocolate amargo 70%',
    ...
    nutrition: null,
    sizes: [
      { id: 'porcion', label: 'Porción individual', size: '1 porción', pieces: 'Porción individual', price: 23 },
      { id: 'completa', label: 'Torta completa', size: '10–12 porciones', pieces: '10 a 12 porciones', price: 220 },
    ],
    badge: 'NUEVO',
    accentClass: 'text-nk-choco',
    btnClass: 'bg-nk-choco hover:bg-nk-gold text-nk-ivory',
  ...
  },
  {
    ...
    description:
      'Torta suave de vainilla con mermelada de frutos rojos y frosting cremoso. Ligera, aromática y sin azúcar añadida.',
    highlights: [
    ...
    nutrition: null,
    sizes: [
      { id: 'porcion', label: 'Porción individual', size: '1 porción', pieces: 'Porción individual', price: 21 },
      { id: 'completa', label: 'Torta completa', size: '10–12 porciones', pieces: '10 a 12 porciones', price: 197 },
    ],
    badge: 'NUEVO',
    accentClass: 'text-nk-gold',
    btnClass: 'bg-nk-gold hover:bg-nk-choco text-nk-ivory',
  ...
  },
  {
    ...
    description:
      'Torta húmeda e intensa de chocolate amargo, preparada con harina de avellana y cubierta con una cremosa ganache de chocolate.',
    highlights: [
    ...
    sizes: [
      { id: 'porcion', label: 'Porción individual', size: '1 porción', pieces: 'Porción individual', price: 21 },
      { id: 'completa', label: 'Torta completa', size: '10–12 porciones', pieces: '10 a 12 porciones', price: 195 },
    ],
    badge: 'NUEVO',
    accentClass: 'text-nk-choco',
    btnClass: 'bg-nk-choco hover:bg-nk-gold text-nk-ivory',
  ...
  },
  {
    ...
    description:
      'Torta húmeda de zanahoria, nueces y pecanas, con un suave toque de canela y especias, rellena y cubierta con un cremoso frosting de queso crema.',
    highlights: [
    ...
    nutrition: null,
    sizes: [
      { id: 'porcion', label: 'Porción individual', size: '1 porción', pieces: 'Porción individual', price: 20 },
      { id: 'completa', label: 'Torta completa', size: '10–12 porciones', pieces: '10 a 12 porciones', price: 193 },
    ],
    badge: 'NUEVO',
    accentClass: 'text-nk-olive',
    btnClass: 'bg-nk-olive hover:bg-nk-choco text-nk-ivory',
  ...
  // ────────────────────────────  CUCHAREABLES  ────────────────────────────
  {
    ...
    description:
      'Postre keto cuchareable de pistacho, cremoso y aromático, elaborado con harina de almendra y pistacho, proteína aislada sabor vainilla y manteca de cacao.',
    highlights: [
      'Pistacho real',
    ...
    nutrition: null,
    sizes: [
      { id: 'unico', label: 'Vaso individual', size: '1 unidad', pieces: 'Vaso individual', price: 28 },
    ],
    badge: 'NUEVO',
    accentClass: 'text-nk-olive',
    btnClass: 'bg-nk-olive hover:bg-nk-choco text-nk-ivory',
  ...
  },
  {
    ...
    description:
      'Postre keto cuchareable de chocolate amargo 70% con avellanas y un crocante irresistible. Intenso, cremoso y con proteína real.',
    highlights: [
      'Chocolate amargo 70%',
    ...
    nutrition: null,
    sizes: [
      { id: 'unico', label: 'Vaso individual', size: '1 unidad', pieces: 'Vaso individual', price: 26 },
    ],
    badge: 'NUEVO',
    accentClass: 'text-nk-choco',
    btnClass: 'bg-nk-choco hover:bg-nk-gold text-nk-ivory',
  ...
  },
  {
    ...
    description:
      'Postre keto cuchareable inspirado en el alfajor, con crema de coco espesa, chocolate amargo 70% y un crumble de almendra y coco.',
    highlights: [
  ...
  },
  {
    ...
    description:
      'Cheesecake keto cuchareable, cremoso y equilibrado, coronado con mermelada de frutos rojos y con base de harina de almendra.',
    highlights: [
      'Mermelada de frutos rojos',
  ...
  },
  {
    ...
    description:
      'Tiramisú keto cuchareable con capas de bizcocho de almendra, café y crema, terminado con cacao puro espolvoreado.',
    highlights: [
  ...
  },
  {
    ...
    description:
      'Tres leches keto cuchareable, húmedo y cremoso, elaborado con leche de almendra y coco y un suave toque de especias.',
    highlights: [
    ...
    nutrition: null,
    sizes: [
      { id: 'unico', label: 'Vaso individual', size: '1 unidad', pieces: 'Vaso individual', price: 25 },
    ],
    badge: 'NUEVO',
    accentClass: 'text-nk-gold',
    btnClass: 'bg-nk-gold hover:bg-nk-choco text-nk-ivory',
  ...
  },
  {
    ...
    description:
      'Postre keto de carrot cake con capas de bizcocho húmedo de zanahoria y especias, acompañado de una suave crema de queso. Cremoso, aromático y perfecto para disfrutar a cucharadas.',
    highlights: [
  ...
  },
  {
    ...
    description:
      'Mousse keto cuchareable de maracuyá, ligero y refrescante, elaborado con pulpa real de maracuyá sobre una base de harina de almendra.',
    highlights: [
    ...
    nutrition: null,
    sizes: [
      { id: 'unico', label: 'Vaso individual', size: '1 unidad', pieces: 'Vaso individual', price: 21 },
    ],
    badge: 'NUEVO',
    accentClass: 'text-nk-gold',
    btnClass: 'bg-nk-gold hover:bg-nk-choco text-nk-ivory',
...
/** true si el carrito contiene algún producto que necesita cadena de frío. */
export function hasRefrigerated(items) {
